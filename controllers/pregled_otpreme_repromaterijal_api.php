<?php
class Pregled_Otpreme_Repromaterijal_Api extends Controller
{
    ...
    public function get_search_prijem($ses)
    {
        ...
        $type_of_goods_id = isset($_GET['type_of_goods_id']) ? ' AND output_repromaterijal.type_of_goods_id= :type_of_goods_id' : '';
        ...
        if ($check_session['login'] == 1) {
            ...
            $sql = "SELECT
                ...
                WHERE  " . $wearehouse . " " . $type_of_goods_id . " " . $goods_id . " " . $client_id . " " . $datum_od . " " . $datum_do . "  AND output_records.exit_date !='0000-00-00 00:00:00' AND output_repromaterijal.sort_of_goods_id='2' AND output_records.stornirano='n' ORDER BY output_records.output_id";
    ...
    public function printExcel($get, $result, $suma){
        ...
        $xml = new ExcelWriterXML('Pregled otpreme repromaterijala.xls');
    ...
    public function getOtpremnica($session_id=null){
        ...
        if( $check_session['login'] == 1){
            ...
            $result = $this->model->get_values($sql, array(":wearehouse_id"=>Session::get('wearehouse_id'), ":sort_of_goods_id"=>"1", ":output_id"=>$output_id));
            $result = $result[0];

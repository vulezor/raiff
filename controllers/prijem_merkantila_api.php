<?php
class Prijem_Merkantila_Api extends Controller
{
    private $_proracun;
    ...
    public function prijem_merkantila(){
        ...
        if( $check_session['login'] == 1){
           ...
           // print_r('documnet br: '.$document_br);
            $input_info= array(
    ...
    public function enable_days(){
        ...
        if( $check_session['login'] == 1){
            $sql = "SELECT DATE_FORMAT(DATE(input_records.input_date),'%e-%c-%Y') as datum FROM input_records
                    ...
                    WHERE input_records.wearehouse_id= :wearehouse_id AND input_merkantila.sort_of_goods_id= :sort_of_goods_id   GROUP BY DATE(input_records.input_date)";
    ...
    public function get_search_type(){
        ...
        if( $check_session['login'] == 1){
            ...
            $sql = "SELECT type_of_goods.type_of_goods_id, type_of_goods.goods_type FROM input_records
                    ...
                    WHERE input_records.wearehouse_id= :wearehouse_id AND input_merkantila.sort_of_goods_id= :sort_of_goods_id AND DATE(input_records.input_date)= :input_date AND input_records.stornirano='n' GROUP BY input_merkantila.type_of_goods_id";
    ...
    public function get_search_good_name(){
        ...
        if( $check_session['login'] == 1){
            ...
            $sql = "SELECT goods.goods_id, goods.goods_name  FROM input_records
                    ...
                    WHERE input_records.wearehouse_id=:wearehouse_id AND input_merkantila.sort_of_goods_id= :sort_of_goods_id AND  DATE(input_records.input_date)= :input_date AND input_merkantila.type_of_goods_id= :type_of_goods_id AND input_records.stornirano='n' GROUP BY goods_id";
    ...
    public function getEnabledDays(){
        ...
        $sql = "SELECT DATE_FORMAT(DATE(input_records.input_date),'%e-%c-%Y') FROM input_records
                INNER JOIN input_merkantila ON( input_merkantila.input_id = input_records.input_id)
                WHERE input_records.wearehouse_id= :wearehouse_id AND input_merkantila.sort_of_goods_id= :sort_of_goods_id AND input_records.stornirano='n'   GROUP BY DATE(input_records.input_date)";
        $obj = array(':wearehouse_id'=>Session::get('wearehouse_id'), ':sort_of_goods_id'=>'1');
        $result = $this->model->get_values($sql,$obj);
        print_r($result);
    }
    ...
    public function prvo_merenje_merkantila($session_id=null){
        ...
        if( $check_session['login'] == 1){
            ...
            $sql='SELECT
                    ...
                    INNER JOIN clients ON (clients.client_id = input_records.client_id)
                    INNER JOIN goods ON (goods.goods_id = input_merkantila.goods_id)
                        WHERE input_records.wearehouse_id= :wearehouse_id AND input_records.exit_date = :exit_date AND input_merkantila.sort_of_goods_id= :sort_of_goods_id AND input_records.stornirano="n" ORDER BY input_records.input_id DESC';
        ...
        if( $check_session['login'] == 1){
           ...
           // print_r($result);return false;
            ...
            if( $result[0]['goods_type']==='kukuruz'){
                ...
                $this->bez_obracuna($result[0]);
            }else if($result[0]['goods_type']==='psenica tel-kel'){
                print_r($result[0]);
                $this->bez_obracuna($result[0]);
    ...
    private function _update_results($obj, $input_id, $input_id1){
        $table = 'input_merkantila';
    ...
    public function select_last_input($session_id=null){
        ...
        $sql='SELECT
                ...
                INNER JOIN goods ON (goods.goods_id = input_merkantila.goods_id)
                INNER JOIN type_of_goods ON (type_of_goods.type_of_goods_id = input_merkantila.type_of_goods_id)
                WHERE input_records.wearehouse_id= :wearehouse_id AND exit_date !="0000-00-00 00:00:00" AND input_merkantila.sort_of_goods_id= :sort_of_goods_id AND input_records.stornirano = :stornirano
    ...
    public function select_odabrani_prijem(){
        ...
        if( $check_session['login'] == 1){
            $sql='SELECT
                ...
                INNER JOIN goods ON (goods.goods_id = input_merkantila.goods_id)
                INNER JOIN type_of_goods ON (type_of_goods.type_of_goods_id = input_merkantila.type_of_goods_id)
                WHERE input_records.wearehouse_id= :wearehouse_id  AND input_merkantila.sort_of_goods_id= :sort_of_goods_id AND input_records.input_id= :input_id';

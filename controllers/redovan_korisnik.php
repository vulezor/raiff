<?php
class Redovan_Korisnik extends Controller{
    ...
    public function __construct(){
        ...
        if($logged == false && $status != 'Redovan_korisnik'){
            unset($logged);
            unset($status);
            Session::destroy();
            header('location: '.URL);
    ...
    public function index(){
        ...
        $this->view->render('redovan_korisnik/index', true);

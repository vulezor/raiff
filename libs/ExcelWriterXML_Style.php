...
class ExcelWriterXML_Style {
     ...
     */
					...
					// All, Left, Top, Right, Bottom, DiagonalLeft, DiagonalRight
						// 0—Hairline, 1—Thin, 2—Medium, 3—Thick
				// Automatic, 6-hexadecimal digit number in "#rrggbb" format or it can be any of the Microsoft® Internet Explorer named colors
			// None, Continuous, Dash, Dot, DashDot, DashDotDot, SlantDashDot, Double
		public function border($position,$weight,$color,$linestyle){
    ...
    public function numberingFormat(){$this->numberFormat = ('#,##0.000');}
    public function redovanFormat(){$this->numberFormat = ('0');}
    public function procenatFormat(){$this->numberFormat = ('#%');}
	/**

...
//			$bE = ($aP['GPF'] && 0x0001) ? TRUE : FALSE;
	...
	function _parse() {
		...
		foreach ($relations->Relationship as $rel) {
			if ($rel["Type"] == Simple_Xlsx::SCHEMA_OFFICEDOCUMENT) {
				...
				$workbookRelations->registerXPathNamespace("rel", Simple_Xlsx::SCHEMA_RELATIONSHIP);
				
				// Read shared strings
				$sharedStringsPath = $workbookRelations->xpath("rel:Relationship[@Type='" . Simple_Xlsx::SCHEMA_SHAREDSTRINGS . "']");
				...
				foreach ($workbookRelations->Relationship as $workbookRelation) {
					if ($workbookRelation["Type"] == Simple_Xlsx::SCHEMA_WORKSHEETRELATION) {

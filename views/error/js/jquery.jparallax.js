...
jQuery.fn.jparallax.settings = {
  ...
  triggerExposesEdges:  false,          // Sets whether the trigger pulls layer edges into view in trying to centre layer content.
	...
	yparallax:				    true,						//
	xorigin:					    0.002,				    // Sets default alignment - only comes into play when travel is not 1
	yorigin:					    0.002,				    //
	xtravel:              0.15,              // Factor by which travel is amplified
	ytravel:              1.5,              //
	takeoverFactor:		    0.80,						// Sets rate of decay curve for catching up with target mouse position

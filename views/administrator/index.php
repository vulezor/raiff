...
<div class="mainWrapper cf" style="overflow-x: hidden">
    ...
    <div data-ng-class="{'aopen':menuOpen===true , 'aclose':menuOpen===false, 'fixedh':headerFixed===true, 'fixed':headerFixed===true}" class="aside"  >
        ...
        <ul data-ng-class="{'menu_b':menuOpen===true , 'menu_a':menuOpen===false}">
            <li><a href="#/" data-ng-class="menuClass('')"><i class="fa fa-home fa-lg"></i> <span>Dashboard</span></a></li>
            <li>
            ...
            <li><a href="#/dispozicije" ng-class="menuClass('dispozicije')"><i class="fa fa-truck fa-lg"></i> <span>Dispozicije</span></a></li>
            <li><a href="#/open_warehouses" ng-class="menuClass('open_warehouses')"><i class="fa fa-database fa-lg"></i> <span>Magacini/Skladišta</span></a></li>
            <li><a href="#/korisnici" ng-class="menuClass(['korisnici','korisnik'])" ><i class="fa fa-group fa-lg"></i> <span>Korisnici</span></a></li>
            <li><a href="#/klijenti" ng-class="menuClass('klijenti')"><i class="fa fa-user-plus fa-lg"></i> <span>Dobavljači/Kupci</span></a></li>
            <li><a href="#/roba" ng-class="menuClass('roba')"><i class="fa fa-file-text  fa-lg"></i> <span>Listing robe</span></a></li>
            <li>
            ...
            <li>
                <a href="#/podesavanja" ng-class="menuClass('podesavanja')">
...
<script type="text/javascript" src="https://maps.google.com/maps/api/js"></script><!--?language=sr-->
